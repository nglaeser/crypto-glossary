...
Schemes:
* **Exclusive OR (XOR, <img alt="\oplus" src="https://render.githubusercontent.com/render/math?math=%5Coplus" style="transform: translateY(20%);" />) secret-sharing**: For a secret _s_, set Party _i_'s share to some random value <img alt="r_i" src="https://render.githubusercontent.com/render/math?math=r_i" style="transform: translateY(20%);" />, except for a designated party which gets <img alt="s \oplus r_1 \oplus \ldots \oplus r_N" src="https://render.githubusercontent.com/render/math?math=s%20%5Coplus%20r_1%20%5Coplus%20%5Cldots%20%5Coplus%20r_N" style="transform: translateY(20%);" />. The shares XOR together to _s_, but each individual share looks random.
